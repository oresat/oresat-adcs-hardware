---
title: "**OreSat Reaction Wheel (RW) Card**"
subtitle: |
...
The OreSat RW Card run the four reaction wheels on the open source [OreSat CubeSat system](https://www.oresat.org/). The RW card:
...
- RW card hardware Git repository: <https://github.com/oresat/oresat-adcs-hardware>
- **TODO:** RW card Design Notes + Design Review Notes
